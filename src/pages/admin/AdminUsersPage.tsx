...
import ManageWalletModal from '../../components/modals/ManageWalletModal';
                        ...
                        <table className="min-w-full divide-y divide-gray-700">
                            <thead className="bg-gray-800/50">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Wallet Balance</th>
                            ...
                            <tbody className="divide-y divide-gray-700">
                                {filteredUsers.map((user) => (
                                    <tr key={user.email} className="hover:bg-gray-800/40 transition-colors duration-200">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-300">${user.walletBalance.toFixed(2)}</td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                            <Button size="sm" variant="outline" onClick={() => setSelectedUser(user)}>Manage Wallet</Button>
